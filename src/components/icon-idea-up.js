  ...
  render() {
    return (
      <div>
        ...
        >
          <title>"Idea Up!"</title>
          <g id="Idea-Up" data-name="Idea Up" className="icon-label">
            <Arrow
              className="icon-idea-up-arrow"
            ...
            />
            <Threads
              className="icon-idea-up-threads"
          ...
          <g
            id="Border-Circle"
            data-name="Border Circle"
            className="icon-border"
          >
            <BorderCircle
              className="icon-idea-up-border-circle"
              cx="438.11"
              cy="438.11"
              r="411.11"
            />
